...
![Latest Released Version](https://img.shields.io/github/v/tag/dawsmac/home-assistant-helm-chart?sort=semver)
![Helm Chart Release](https://github.com/dawsmac/home-assistant-helm-chart/actions/workflows/build-helm-chart-release.yaml/badge.svg)
![Auto-update latest HA version](https://github.com/dawsmac/home-assistant-helm-chart/actions/workflows/check_ha_release.yml/badge.svg)
...
```console
$ helm repo add dawsmac http://dawsmac.github.io/home-assistant-helm-chart/
$ helm repo update
